...
class Car {
  ...
  Car(this.brand, this.model, this.price, this.condition, this.image);
}
/*
Future<List<Car>> getCarListFromFirestore() async {
  // Access the "cars" collection in Firestore
  QuerySnapshot<Map<String, dynamic>> snapshot =
      await FirebaseFirestore.instance.collection('cars').get();
      
  // Convert the retrieved data to a list of Car objects
...
class DealerS {
  ...
  DealerS(this.name, this.offers, this.image);
}

List<DealerS> getDealerList() {
  return <DealerS>[
    DealerS(
      "Hertz",
      174,
